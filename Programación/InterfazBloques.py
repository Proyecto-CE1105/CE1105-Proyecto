...
<<<<<<<< Updated upstream:Programación/InterfazBloques.py
from Blocks import BloqueAcero, BloqueConcreto, BloqueMadera
========
import Blocks.BloqueAcero as BloqueAcero, Blocks.BloqueConcreto as BloqueConcreto, Blocks.BloqueMadera as BloqueMadera
>>>>>>>> Stashed changes:Game/Blocks/InterfazBloques.py
