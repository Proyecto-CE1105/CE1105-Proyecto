...
labelEmail = Label.Label('Email:',20, 675,300,(0,0,0))
labelPassword = Label.Label('Password:',20, 675,300, (0,0,0))
labelPasswordRegister = Label.Label('Password:',20, 675,350,(0,0,0))
...
while True:
    for event in pygame.event.get():
        ...
        if passwordRegister_entry.is_clicked(mouse.get_pos()):
            ...
            passwordRegister_entry.activeness = True
        else:
            passwordRegister_entry.color = passwordRegister_entry.colorPassive
            passwordRegister_entry.activeness = False
    ...
    if WantToShowObjectsSignUp == True:
        ...
        passwordRegister_entry.input_user = pygame.Rect(passwordRegister_entry.x, 350, 140, 32)
        passwordRegister_entry.drawEntry(MainWindow)

        labelUser.draw(MainWindow)
        labelEmail.draw(MainWindow)
        labelPasswordRegister.draw(MainWindow)
